...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2016 at 04:47 PM
...
INSERT INTO `colour` (`colour_name`, `colour_status`, `colour_createdon`, `colour_updatedon`, `product_id`) VALUES
('Navy Blue', '1', NULL, NULL, 1),
('Shinning Black', '1', NULL, NULL, 1),
('Sky Blue', '1', NULL, NULL, 1),
('Metal Grey', '1', NULL, NULL, 1);
...
INSERT INTO `products` (`products_id`, `products_name`, `products_catagory`, `products_size`, `products_colour`, `products_price`, `products_featured`, `products_discount`, `products_vendor`, `products_status`, `products_createdon`, `products_updatedon`, `products_rating`, `image_link`, `product_desc`) VALUES
(1, 'Armani Jeans', 2, NULL, NULL, '400', '1', 10, NULL, '1', NULL, NULL, '4', '/images/products/jeans/1.1.jpg', 'Five-pocket jean in slim silhouette featuring slightly tapered leg and zip fly with button closure. Leg Opening size of 14.5 Inches, Zipper closure and Machine wash. Made up of imported soft cotton material.\nBroken Oyster, Blue Barnacle, Record Skip, Black Dell, Whiteout, and Broken In washes come with distressed finishing that offers a worn-in look.'),
(2, 'Metallic Black Jeans', 2, NULL, NULL, '500', '1', 34, NULL, '1', NULL, NULL, '3', '/images/products/jeans/2.1.jpg', NULL),
(3, 'Silver Lining Black Jeans', 2, NULL, NULL, '340', '1', 22, NULL, '1', NULL, NULL, '5', '/images/products/jeans/2.2.jpg', NULL),
(4, 'Light Blue Jeans', 2, NULL, NULL, NULL, '1', NULL, NULL, '1', NULL, NULL, '3', '/images/products/jeans/4.2.jpg', NULL),
(5, 'Black & White art Jeans', 2, NULL, NULL, NULL, '1', NULL, NULL, '1', NULL, NULL, NULL, '/images/products/jeans/7.1.jpg', NULL),
(6, 'Skinny Joes Black Jeans', 2, NULL, NULL, NULL, '1', NULL, NULL, '1', NULL, NULL, NULL, '/images/products/jeans/6.1.jpg', NULL),
(7, 'Skinny Blue Cut Jeans', 2, NULL, NULL, NULL, '1', NULL, NULL, '1', NULL, NULL, NULL, '/images/products/jeans/5.2.jpg', NULL),
(8, 'Plain Blue jeans', 2, NULL, NULL, NULL, '1', NULL, NULL, '1', NULL, NULL, NULL, '/images/products/jeans/4.3.jpg', NULL),
(9, 'Skinny White Blue Jeans', 2, NULL, NULL, NULL, '1', NULL, NULL, '1', NULL, NULL, NULL, '/images/products/jeans/5.1.jpg', NULL),
(10, 'Plain Black Jeans', 2, NULL, NULL, NULL, '1', NULL, NULL, '1', NULL, NULL, NULL, '/images/products/jeans/3.3.jpg', NULL),
(11, 'Plazo Black Jeans', 2, NULL, NULL, NULL, '1', NULL, NULL, '1', NULL, NULL, NULL, '/images/products/jeans/3.2.jpg', NULL);
...
INSERT INTO `size` (`size_name`, `size_status`, `size_createdon`, `size_updatedon`, `product_id`) VALUES
('M', '1', NULL, NULL, 1),
('L', '1', NULL, NULL, 1),
('XXL', '1', NULL, NULL, 1);
