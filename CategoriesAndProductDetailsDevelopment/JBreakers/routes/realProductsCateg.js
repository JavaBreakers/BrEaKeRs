    ...
    if(req.session && req.session.username)
    {
        ...
        req.getConnection(function (err, connection)
        {
                ...
                connection.query(query, function (err, rows)
                {
                    ...
                    } else {//res.render('childCateg', {title: "Really Sorry"});
                }
...
router.post('/realProductsCateg', function (req, res, next)
{
    ...
    console.log("YOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOPPPPPPPPPPPPPPPPSSSSSSSSSSSSSSSSSSS");
    ...
    req.getConnection(function (err, connection)
    {
        ...
        connection.query(query, function (err, rows)
        {
            ...
            if (rows.length)
            {
                console.log("YOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOKKKKKKKKJJJJJJJJJJJjjj");
                res.render('realProductsCateg', {myData: rows, pageNumber: page_number });
            }
            else
            {// res.render('mycateg', {title: "Really Sorry"});
            }
        });
    });
