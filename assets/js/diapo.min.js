    ...
    a.fn.diapo = function(b, c) {
        function G(c) {
            ...
            while (I < J) {
                ...
                T.css({height: Math.floor(g / m + N + 1), left: O, top: P, width: Math.floor(h / n + M + 1)});
                a("> " + b.selector, T).not("#pix_canvas").not("#pix_canvas_wrap").not("#pix_next").not("#pix_prev").not("#pix_commands").css({height: g, "margin-left": "-" + O + "px", "margin-top": "-" + P + "px", width: h});
                O = O + T.width() - 1;
                if (I % n == n - 1) {
                    P = P + T.height() - 1
                }
            ...
            a.each(Q, function(c, u) {
                function D() {
                    ...
                    if (a(".diapoeased").length == J) {
                        ...
                        if (c != 0) {
                            a(".diapocurrent .fromLeft, .diapocurrent .fromRight, .diapocurrent .fromTop, .diapocurrent .fromBottom, .diapocurrent .fadeIn").each(function() {
                                ...
                                if (j.indexOf("fromLeft") != -1) {
                                    d.css({left: "-" + m + "px", right: "auto"});
                                    d.css("visibility", "visible").delay(w / c * .1 * (k - 1)).animate({left: g.left}, w / c * .2, b)
                                } else if (j.indexOf("fromRight") != -1) {
                                    d.css({left: m + "px", right: "auto"});
                                    d.css("visibility", "visible").delay(w / c * .1 * (k - 1)).animate({left: g.left}, w / c * .2, b)
                                } else if (j.indexOf("fromTop") != -1) {
                                    d.css({top: "-" + l + "px", bottom: "auto"});
                                    d.css("visibility", "visible").delay(w / c * .1 * (k - 1)).animate({top: g.top}, w / c * .2, b)
                                } else if (j.indexOf("fromBottom") != -1) {
                                    d.css({top: l + "px", bottom: "auto"});
                                    d.css("visibility", "visible").delay(w / c * .1 * (k - 1)).animate({top: g.top}, w / c * .2, b)
                                } else if (j.indexOf("fadeIn") != -1) {
                                    d.animate({opacity: 0}, 0).css("visibility", "visible").delay(w / c * .1 * (k - 1)).animate({opacity: 1}, w / c * .2, b)
                                }
                            })
                        }
                        ...
                        q.eq(d).hide();
                        a("#pix_canvas").animate({opacity: b.loaderOpacity}, 400);
                            ...
                            if (a.browser.msie && a.browser.version < 9 || b.loader == "bar") {
                                if (z <= 1 && !f.hasClass("stopped")) {
                                    ...
                                    if (!f.hasClass("stopped"))
                                        t();
                                    clearInterval(i);
                                    a("#pix_canvas").animate({opacity: 0}, 200, function() {
                                ...
                                if (z <= 1 && !f.hasClass("stopped")) {
                                    ...
                                    if (!f.hasClass("stopped"))
                                        t();
                                    clearInterval(i);
                                    a("#pix_canvas, #pix_canvas_wrap").animate({opacity: 0}, 200, function() {
                                        setTimeout(F, b.transPeriod + s);
                                        G()
                                    })
                                }
                ...
                if (y == "scrollLeft" || y == "scrollRight" || y == "scrollTop" || y == "scrollBottom" || y == "scrollHorz") {
                    v.delay((b.transPeriod + s) / J * R[c] * p * .5).css({display: "block", height: height, "margin-left": marginLeft, "margin-top": marginTop, width: width}).animate({height: Math.floor(g / m + N + 1), "margin-top": 0, "margin-left": 0, width: Math.floor(h / n + M + 1)}, b.transPeriod - s, C, D);
                    q.eq(d).delay((b.transPeriod + s) / J * R[c] * p * .5).animate({"margin-left": marginLeft * -1, "margin-top": marginTop * -1}, b.transPeriod - s, C, function() {
                        jQuery(this).css({"margin-top": 0, "margin-left": 0})
                    })
                } else {
                    if (H == "next") {
                        v.delay((b.transPeriod + s) / J * R[c] * p * .5).css({display: "block", height: height, "margin-left": marginLeft, "margin-top": marginTop, width: width, opacity: 0}).animate({height: Math.floor(g / m + N + 1), "margin-top": 0, "margin-left": 0, opacity: 1, width: Math.floor(h / n + M + 1)}, b.transPeriod - s, C, D)
                    } else {
                        q.eq(k).show().css("z-index", "999").addClass("diapocurrent");
                        q.eq(d).css("z-index", "1").removeClass("diapocurrent");
                        v.delay((b.transPeriod + s) / J * R[c] * p * .5).css({display: "block", height: Math.floor(g / m + N + 1), "margin-top": 0, "margin-left": 0, opacity: 1, width: Math.floor(h / n + M + 1)}).animate({height: height, "margin-left": marginLeft, "margin-top": marginTop, width: width, opacity: 0}, b.transPeriod - s, C, D)
                    }
                }
                if (l == true) {
                    a("#pix_prev")[j](function() {
                        if (!f.hasClass("diaposliding")) {
                            ...
                            clearInterval(i);
                            t();
                            a("#pix_canvas, #pix_canvas_wrap").animate({opacity: 0}, 0);
                            F();
                            if (b != 0) {
                                G(b)
                            } else {
        ...
        var d = {selector: "div", fx: "random", mobileFx: "", slideOn: "random", gridDifference: 250, easing: "easeInOutExpo", mobileEasing: "", loader: "pie", loaderOpacity: .8, loaderColor: "#ffff00", loaderBgColor: "#222222", pieDiameter: 50, piePosition: "top:5px; right:5px", pieStroke: 8, barPosition: "bottom", barStroke: 5, navigation: true, mobileNavigation: true, navigationHover: true, mobileNavHover: true, commands: true, mobileCommands: true, pagination: true, mobilePagination: true, thumbs: true, hover: true, pauseOnClick: true, rows: 4, cols: 6, slicedRows: 8, slicedCols: 12, time: 3e3, transPeriod: 1500, autoAdvance: true, mobileAutoAdvance: true, onStartLoading: function() {
            }, onLoaded: function() {
            ...
            if (m == true) {
                if (e()) {
                    f.live("vmouseover", function() {
                        a("#pix_prev, #pix_next").animate({opacity: 1}, 200)
                    });
                    f.live("vmouseout", function() {
                        a("#pix_prev, #pix_next").delay(500).animate({opacity: 0}, 200)
                    })
                } else {
                    f.hover(function() {
                        a("#pix_prev, #pix_next").stop(true, false).animate({opacity: 1}, 200)
                    }, function() {
                        a("#pix_prev, #pix_next").stop(true, false).animate({opacity: 0}, 200)
                    })
                }
            }
        ...
        if (a.browser.msie && a.browser.version < 9 || b.loader == "bar") {
            ...
            x.css({position: "absolute", left: 0, "z-index": 1001, height: b.barStroke, width: 0, "background-color": b.loaderColor})
        } else {
        ...
        if (l == true) {
            ...
            a("#pix_prev").animate({opacity: 0}, 200)
        }
        ...
        if (o == true) {
            ...
            for (C = 0; C < r; C++) {
                ...
                if (b.thumbs == true) {
                    ...
                    var E = new Image;
                    E.src = D;
                    a("li#pag_nav_" + C).append(a(E).attr("class", "pix_thumb").css("position", "absolute").animate({opacity: 0}, 0));
                    a("li#pag_nav_" + C + " > img").after('<div class="thumb_arrow" />');
                    a("li#pag_nav_" + C + " > .thumb_arrow").animate({opacity: 0}, 0);
                    if (!e()) {
                        a("#pix_pag li").hover(function() {
                            a(".pix_thumb, .thumb_arrow", this).addClass("visible").stop(true, false).animate({"margin-top": -15, opacity: 1}, 300, "easeOutQuad")
                        }, function() {
                            a(".pix_thumb, .thumb_arrow", this).removeClass("visible").stop(true, false).animate({"margin-top": 0, opacity: 0}, 150)
                        })
                    }
                }
            }
        ...
        if (m == true) {
            a("#pix_prev, #pix_next").animate({opacity: 0}, 0)
        }
        F();
        a(".fromLeft, .fromRight, .fromTop, .fromBottom, .fadeIn").each(function() {
            a(this).css("visibility", "hidden")
